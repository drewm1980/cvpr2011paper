...
\begin{figure}
\centering
\includegraphics[width=3.5in]{figures/alignment_stage_runtime.pdf}
\caption{Alignment Stage Time vs. Size of Training Database}
\label{fig:alignment_stage_runtime}
\end{figure}

\subsection{Face Recognition Stage Benchmarks}
\label{sec:recognition_benchmark}
Since we use a reduced training set for the recognition stage, our third
experiment was to find the relationship between the probability that the true
subject is in the training set vs the number of users in the reduced training
set and the speed of the recognition stage w.r.t.  the number of subjects in
the training set.  
