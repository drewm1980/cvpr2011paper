...
Based on the strength of the results for our single-kernel implementation, we chose to follow
a single kernel strategy for the alignment stage. 

% DREW Idea... in hindsight, maybe we should still try many kernel launches, even if it
% means individual instances can't terminate early.
