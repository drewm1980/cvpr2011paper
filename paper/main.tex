...
GPUs are comprised of several streaming multiprocessors (SMP) (15 for our
...
For our system, each SMP has 64 kb of L1 cache with a total of 960 kb of L1 cache/shared memory and
...
that solve a single large instance of the $\ell_1$-minimization problem (Algorithm \ref{alg:alm}).  
...
$A$ and $A'A$ matrix and the y-axis represents the average amount of time it to complete
