...
%\begin{equation}
%\min_{\x, \e} \|\e\|_1 \quad \subj \quad \bb = A_i \x + \e.
%\end{equation}
%Where $A_i$ contains the training images for user $i$ as well as several vectors consisting of the
...
\STATE {\bf Output:} $\mbox{identity}(\bb) = \arg\min_i r_i(\y)$.
\end{small}
\end{algorithmic}
\end{algorithm}
