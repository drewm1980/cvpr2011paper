...
\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{figures/cpu_caches}
\end{center}
\caption{Scale Drawing of the caches on a E5530 CPU }
\label{fig:caches}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{figures/gpu_caches}
\end{center}
\caption{Scale Drawing of the caches on a GTX480 GPU}
\label{fig:caches}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{figures/arrays}
\end{center}
\caption{Scale Drawing of the algorithm data structures}
\label{fig:caches}
\end{figure}
...
column norm.  The ratio of $d/n$ =$1/2$ with $n$ varying
from 1000 to 8000.  The ground truth signals, $\xx_0$ had a sparsity rate of 10\% of d
...
terminated when $\|\bx-\bx_0\| < \tau$ with $\tau=10^{-3}$.  The measurement vector was generated
