...
during solver execution, with the sole exception of the pseudo-inverse of $B_j$,
...
% To do list:
%Add experiment timing for one instance per core on cpu?
%Unify plot styles
%Interpret 2 percent accuracy difference
%Update speed comparisons and diagrams to GTX 580?
%Better citation for previously reported speed?
%Figure tweaks from Allen
