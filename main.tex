...
% A few things in cvpr style file but not in ACM...
\def\eg{\emph{e.g.\ }} 
\def\ie{\emph{i.e.\ }} 
...
\conferenceinfo{PPoPP '12}{Feb. 29, New Orleans.} 
\copyrightyear{2012} 
\copyrightdata{[to be supplied]} 

\titlebanner{REVIEW COPY; PLEASE TO NOT REDISTRIBUTE}        % These are ignored unless
...
%\authorinfo{Name2\and Name3}
           %{Affiliation2/3}
           %{Email2/3}
\authorinfo{Andrew Wagner\and Yi Ma}
			{University of Illinois at Urbana-Champaign}
			{\{awagner,yima\}@illinois.edu}
\authorinfo{Victor Shia\and Allen Yang\and Mark Murphy}
			{University of California Berkeley}
			{\{vshia,yang,mjmurphy\}@eecs.berkeley.edu}
%\authorinfo{Allen Yang}
			%{University of California Berkeley}
			%{yang@eecs.berkeley.edu}
%\authorinfo{Mark Murphy}
			%{University of California Berkeley}
			%{mjmurphy@eecs.berkeley.edu}
%\authorinfo{Yi Ma}
			%{University of Illinois at Urbana-Champaign}
			%{yima@illinois.edu}
