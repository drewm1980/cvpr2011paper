...
parallelism onto both core-level and sse-level cpu concurrency.  In other
...
core-level and sse-level concurrency.  For operations that do not map well
onto existing libraries, we achieve both sse-level and core-level
...
as a wrapper for MKL, and, like our proposed implementation, achieves sse-level concurrency implicitly.  
