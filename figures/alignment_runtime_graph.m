...
plot( userCount, gtx480, 'k-', userCount, cpu1, 'k:' , userCount, cpu2, 'k--');
legend('GPU', 'CPU, library threading', 'CPU, manual threading', 'Location','NorthWest');

%plot( userCount, GTX 580, 'k-' , userCount, cpu1, 'k:' , userCount, cpu2, 'k--');
%plot( userCount, GTX 580, 'kx-' , userCount, cpu1, 'k*-' , userCount, cpu2, 'ko-');
